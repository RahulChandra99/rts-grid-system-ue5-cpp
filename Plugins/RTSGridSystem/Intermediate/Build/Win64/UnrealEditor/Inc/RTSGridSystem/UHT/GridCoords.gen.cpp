...
template<> RTSGRIDSYSTEM_API UScriptStruct* StaticStruct<FGridCoord>()
{
	...
	struct Z_CompiledInDeferFile_FID_GameDevelopment_UnrealEngine_Projects_RTSMechanics_Plugins_RTSGridSystem_Source_RTSGridSystem_Public_GridCoords_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_GameDevelopment_UnrealEngine_Projects_RTSMechanics_Plugins_RTSGridSystem_Source_RTSGridSystem_Public_GridCoords_h_Statics::ScriptStructInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_GameDevelopment_UnrealEngine_Projects_RTSMechanics_Plugins_RTSGridSystem_Source_RTSGridSystem_Public_GridCoords_h_4140419252(TEXT("/Script/RTSGridSystem"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_GameDevelopment_UnrealEngine_Projects_RTSMechanics_Plugins_RTSGridSystem_Source_RTSGridSystem_Public_GridCoords_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_GameDevelopment_UnrealEngine_Projects_RTSMechanics_Plugins_RTSGridSystem_Source_RTSGridSystem_Public_GridCoords_h_Statics::ScriptStructInfo),
		nullptr, 0);
